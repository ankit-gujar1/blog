...
const { getAllBlogs, getAllBlogsByUserId, get8PopularBlogs, getAllPopularBlogs, postBlog, deleteBlog, updateBlog, likeBlog, dislikeBlog, get8Blogs, getBlogByBlogId, getBlogByUserId }=require('../controllers/blogController');
...
router.get('/get-blog/:id',requireUserAuth,getBlogByBlogId); //get one blog for edit, delete and view blog
router.get('/all-blogs/:id',requireUserAuth,getBlogByUserId); //all blogs by user id
